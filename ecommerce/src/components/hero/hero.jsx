      ...
      <div className="relative w-full h-[480px] ">
        ...
        <div className='absolute h-[100%] w-[100%] flex flex-col items-center  ' >
          ...
          <div className='flex items-center justify-evenly w-[390px] mt-4'>
            <button className='bg-green-500 border-none px-3 h-[45px] text-white font-bold rounded-3 shadow-[0_0_30px_green] hover:scale-x-115 hover:brightness-110 transition-all duration-400 ease-in-out  ' on onClick={()=> navigation('/all/products')}>SHOPE NOW</button>
            <button className=' border-3 border-black px-3 h-[45px] text-white font-bold rounded-3 hover:scale-105 hover:bg-black transition-all duration-500 ease-in-out' onClick={()=> document.getElementById('collection').scrollIntoView({behavior:'smooth'})}>Explore Collection</button>
