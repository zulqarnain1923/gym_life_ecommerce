...
function Catagory() {
    ...
    // const ctg=useRef(['All','Diet and Supplements','Gym apparel','Footer','Accessries'])
                ...
                <div className='bg-dark pb-5 flex flex-col justify-center items-center'>
                    ...
                    <div className='flex flex-wrap gap-2 sm:gap-4 p-1 min-h-[150px] w-full justify-center items-center left_section'>
                        {catagories.map((item, index) => (
                            <div key={index} className='h-[100px] sm:h-[130px] w-full  max-w-[84px] sm:max-w-[117px] bg-[#020617] p-2 sm:p-3 flex  flex-col items-center justify-between rounded-md hover:shadow-[0px_0px_30px_green] hover:bg-green-400 hover:scale-[1.1] transition-all duration-300 cursor-pointer' onClick={() => call(item.name)}>
